...
class TrainOptions:
    ...
    def initialize(self):
        self.parser.add_argument('--exp_dir', type=str, default='exp_dir',
        ...
        # 0 -> 5 -> 1
        self.parser.add_argument('--aging_lambda', default=1, type=float,
        ...
        self.parser.add_argument('--max_steps', default=1000, type=int,
